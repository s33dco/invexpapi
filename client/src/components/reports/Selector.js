	...
	return (
		<Container>
			...
			<Typography
				...
				align="center"
			>
				The figures are broken down via the HMRC categories and
				available to print of download. Your end of year tax return is
			...
			{invoices.length === 0 && expenses.length === 0 && (
				<Typography
					...
					align="center"
				>
					You will be able to run reports after some data has been
					created.
				</Typography>
			)}
			<Container className={classes.dates}>
				<Container className={classes.datePicker}>
					<DatePicker
						...
						helperText={
							formError.start.length > 1 ? formError.start : ''
						}
						format="Do MMMM YYYY"
